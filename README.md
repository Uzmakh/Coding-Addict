...
keep the 'react auto import' uncheck
...
Fragment - let's group elements without adding extra nodes
...
<!-- Just for example..notice the camelCase -->
...
{books.map((book) => {
console.log(book);
<!-- If this type of setup, id will be set in div not in h2 -->
        // return 'hello';
        return (
          <div>
            <h2>{book.title}</h2>
...
<!-- We have the similar approach in Reactjs-->
...
we pass the variable  or function through all nested components as props that is annoying- this is the concept of prop-drilling. The annoying part of passing prop literally down n down, passing through say 10 components
...
split up the app in components and
Keep the relevant code in its component
